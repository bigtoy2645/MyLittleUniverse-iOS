...
extension UIImage {
    ...
    static let textAlignCenterOn = UIImage(named: "edge/TextAlign-Center-On_24")
    static let textAlignCenterOff = UIImage(named: "edge/TextAlign-Center-Off_24")
    static let textAlignCenterDisabled = UIImage(named: "edge/TextAlign-Center-Disabled_24")
    static let textAlignLeftOn = UIImage(named: "edge/TextAlign-Left-On_24")
    static let textAlignLeftOff = UIImage(named: "edge/TextAlign-Left-Off_24")
    static let textAlignLeftDisabled = UIImage(named: "edge/TextAlign-Left-Disabled_24")
    static let textAlignRightOn = UIImage(named: "edge/TextAlign-Right-On_24")
    static let textAlignRightOff = UIImage(named: "edge/TextAlign-Right-Off_24")
    static let textAlignRightDisabled = UIImage(named: "edge/TextAlign-Right-Disabled_24")
